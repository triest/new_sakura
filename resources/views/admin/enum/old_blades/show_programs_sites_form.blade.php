...
@section('title', 'Свойства шоу-программы на площадке')

@section('inner')
    <div class="row mb-4">
        <div class="col-sm-4 mb-xl-0">
            <h3>Свойства шоу-программы на площадке</h3>
            <h6 class="font-weight-normal mb-0 text-muted">Справочник: Шоу-программы на площадках.</h6>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    @component('common.form', [
                        'edit' => true,
                        'action' => route('admin.enum.show_programs_sites.update', $item->id),
                        'media' => true
                    ])
                        <row class="row">
                            <div class="col-6 mb-3">
                                <h4>Площадка: {{ $item->site->title }}</h4>
                                <h5>Шоу-программа: {{ $item->showProgram->title }}</h5>
                            </div>
                        </row>
                        <div class="row">
                            <div class="col-lg-8">
...
{{--                                    Цена @endcomponent--}}
                                @component('common.form.input_ckeditor', ['name' => 'description', 'value' => old('description') ?? $item->description])
                                    Описание @endcomponent
                                <h5>Фотографии шоу-программы:</h5>
                                <div class="row">
                                        ...
                                        <div
                                            ...
                                            <div class="btn-group">
                                                <a class="btn btn-primary btn-sm button-media-cover"
                                                   ...
                                                   data-url="{{ route('admin.enum.show_programs_sites.media_cover', [$item->id, $media->id]) }}">
                                                    <i class="mdi mdi-shield-check menu-icon"></i>
                                                </a>
                                                <a class="btn btn-warning btn-sm button-media-delete"
                                                   title="Удалить" href="#"
                                                   data-url="{{ route('admin.enum.show_programs_sites.media_delete', [$item->id, $media->id]) }}">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-8">
                                        @component('common.form.input_gallery', ['name' => 'gallery', 'gallery' => ''])
                                            Добавить Фотографию шоу-программы @endcomponent
                                    </div>
                                    <div class="col-4">
                        ...
                        <a href="{{ route('admin.enum.show_programs_sites.index', $item->sites_id) }}"
