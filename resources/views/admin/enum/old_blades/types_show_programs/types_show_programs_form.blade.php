...
@section('title', 'Тип шоу программы')

@section('inner')
    <div class="row mb-4">
        <div class="col-sm-4 mb-xl-0">
            <h3>Тип шоу программы</h3>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    'edit' => isset($item->id),
                    'action' => isset($item->id) ? route('admin.enum.types_show_programs.update', $item->id) : route('admin.enum.types_show_programs.store'),
                    ])
                        <div class="row">
                            <div class="col-lg-8">
                        ...
                        <a href="{{ route('admin.enum.types_show_programs.index') }}" class="btn btn-light">Отмена</a>
                    @endcomponent
                </div>
            </div>
        </div>
